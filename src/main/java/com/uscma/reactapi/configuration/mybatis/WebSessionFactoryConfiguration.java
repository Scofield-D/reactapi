 ...
 */
@Configuration
@MapperScan(basePackages = "com.uscma.reactapi.domain.mapper.web", sqlSessionFactoryRef = "webSqlSessionFactory")
public class WebSessionFactoryConfiguration {
    ...
    public SqlSessionFactory activitySqlSessionFactory(@Qualifier("webDataSource") DataSource dataSource) throws Exception {
        ...
        sfb.setTypeAliasesPackage("com.uscma.reactapi.domain.model.web");
