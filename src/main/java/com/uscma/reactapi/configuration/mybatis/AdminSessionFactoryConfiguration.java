package com.uscma.reactapi.configuration.mybatis;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.uscma.reactapi.domain.mapper.admin", sqlSessionFactoryRef = "adminSqlSessionFactory")
public class AdminSessionFactoryConfiguration {
    ...
    public SqlSessionFactory activitySqlSessionFactory(@Qualifier("adminDataSource") DataSource dataSource) throws Exception {
        ...
        sfb.setTypeAliasesPackage("com.uscma.reactapi.domain.model.admin");
