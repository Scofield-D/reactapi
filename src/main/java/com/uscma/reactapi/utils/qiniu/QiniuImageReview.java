package com.uscma.reactapi.utils.qiniu;

import com.uscma.reactapi.configuration.qiniu.QiNiuProperties;
import com.uscma.reactapi.domain.exception.CustomizeException;
import com.uscma.reactapi.domain.response.CensorResp;
import com.uscma.reactapi.domain.response.DiscriResp;
